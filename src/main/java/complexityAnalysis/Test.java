...
public class Test {
  ...
  /**
   * Complexity example of O(1)
   * Takes two number a and b and return the sum of a and b
   ...
   * Print values from 1 to n recursively
